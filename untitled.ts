...
//Converting ms into kms 1 mile = 1.60934 kilometer
...
let friendsName:string[] = ["Amaan","Bismah","Faiza","Sahar","Tabish"];
...
const Print = (NUM1:number,NUM2:number) =>{
...
//Calculator function
function Calculator(value1:number,value2:number,operator:string) {
    if(operator === "+"){
