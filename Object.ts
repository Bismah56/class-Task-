...
let people : {friends:object[]} = {
    friends: []
};

//type alias for friend objects
type FriendsObj = {
    firstName : string,
    lastName : string,
    userID? : string 
...
//Each friends Info
const friend1:FriendsObj = {
    firstName : "Laila",
    lastName : "Wasti",
    userID : "Lailadesu" 
};

const friend2:FriendsObj = {
    firstName : "Amna",
    lastName : "Kamal" 
};

const friend3:FriendsObj = {
    firstName : "Bisma",
...
//Template for Organizing Student Details
interface Student {
    name : string,
    isSenior : boolean,
...
function findSeniorStudentsWithAssignments (Class_List:Student[]) {
    let studentsFound = [];
...
function RemovingStudentsWithIncompleteAssignments(Class_List:Student[]) {
